...
``` {r, reliability{{nfact}}, eval = TURE, echo = FALSE}
### get item response theory parameters so you can get reliability
fairt{{nfact}} <- fa2irt(f = fanal{{nfact}}, rho = imputedResults{{nfact}})
score{{nfact}} <- scoresIrt(fanal{{nfact}}, imputedNumericDF{{nfact}}, plot = FALSExsxsxs)
